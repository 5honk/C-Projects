...
4. We can finally push the file 
    git push -u origin main

5. A prompt will appear to enter your Github username and password. Since Github does'nt use the passwords for authentication, a token will need to be generated as the password
